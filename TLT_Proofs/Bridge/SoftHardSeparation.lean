...
Authors: Dhruv Gupta
-/
import TLT_Proofs.Bridge.SoftAttention
...
- `soft_vs_hard_attention_separation` — the conjunction of the two halves.
-/
...
theorem soft_vs_hard_attention_separation
  ...
  ⟨fun d nK => softAttention_wellBehaved d nK,
   attention_architecture_produces_non_borel_bad_event hex⟩
